...
echo "Start training"
python examples/unianimate_wan/train_unianimate_wan_sstk.py   --task train     --train_architecture lora    --lora_rank 64 --lora_alpha 64     --dataset_path data/example_dataset      --output_path /gen_ca/j1wen/UniAnimate-DiT/models_out_sstk350k      \
