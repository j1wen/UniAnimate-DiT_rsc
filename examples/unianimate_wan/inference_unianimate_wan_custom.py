...
test_list_path = [
    ...
    [
        1,
        "data/images/dress01.webp",
        "data/saved_pose/mimo4_dress01_center_2.0x",
    ],
    [
        1,
        "data/images/dress02.webp",
        "data/saved_pose/mimo4_dress02_center_2.0x",
    ],
    [
        1,
        "data/images/l--20240912--1222--PAF165--pilot--Detector_02150.jpg",
        "data/saved_pose/l--20240912--1222--PAF165--pilot--Detector_02150",
    ],
    [
        1,
        "data/images/l--20240912--1222--PAF165--pilot--Detector_02150.jpg",
        "data/saved_pose/l--20240912--1222--PAF165--pilot--Detector_02150_long",
    ],
]
...
for path_dir_per in test_list_path:
    ...
    save_video(
        ...
        "{}/video_480P_{}_{}.mp4".format(
            args.save_dir, ref_image_path.split("/")[-1], pose_file_path.split("/")[-1]
        ),
        fps=15,
        quality=5,
    )
